...
const routeConfig = {
  ...
  '/multiverse': { priority: '0.9', changefreq: 'monthly' },
  ...
  '/bookstore/quantum-leap': { priority: '0.7', changefreq: 'monthly' },
  '/bookstore/quantum-love': { priority: '0.7', changefreq: 'monthly' },
  '/bookstore/nobel-peace': { priority: '0.7', changefreq: 'monthly' },
  '/bookstore/starseed-queens': { priority: '0.7', changefreq: 'monthly' },
  '/bookstore/quincey-obsession': { priority: '0.7', changefreq: 'monthly' },
  ...
  '/partnerships': { priority: '0.8', changefreq: 'monthly' },
